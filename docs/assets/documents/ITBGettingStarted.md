...
![ITB Register Community](/docs/assets/images/ITBRegisterCommunity.png)

5. Populate the fields with data that fits your organization. Below is an example with a company called 'GodSoftware'.
![ITB Populare Organization Details](/docs/assets/images/ITBPopulateOrgDetails.png)
...
![ITB Create USer](/docs/assets/images/ITBCreateUser.png)
