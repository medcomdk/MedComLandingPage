...
<ol>
  ...
  <li>
  In some test cases, a manual review by MedCom is required. When you are ready for MedCom to review an entire test statement, please contact the MedCom employee responsible for managing your test process.
    <figure>
